...
router.post('/', cache('10 minutes'), controller.create.bind(controller), responseHandler);
router.put('/:announcement_id', cache('10 minutes'), controller.update.bind(controller), responseHandler);
